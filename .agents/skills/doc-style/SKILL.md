...
| 维度 | 评估标准 | 得分 |
| --- | --- | --- |
| **直接性** | 直接陈述事实还是绕圈宣告？（8 分：直截了当，1 分：充满铺垫） | /8 |
| **节奏** | 句子长度是否变化？（8 分：长短交错，1 分：机械重复） | /8 |
| **信任度** | 是否尊重读者智慧？（8 分：简洁明了，1 分：过度解释） | /8 |
| **真实性** | 听起来像真人说话吗？（8 分：自然流畅，1 分：机械生硬） | /8 |
| **精炼度** | 还有可删减的内容吗？（8 分：无冗余，1 分：大量废话） | /8 |
