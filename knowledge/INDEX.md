...
- 2026-07-16：完成 [APM 关联容器日志采集项慢接口优化](./bkmonitor/issues/2026-07-10-apm-k8s-log-relation-cache/README.md)（[TencentBlueKing/bk-monitor #11539](https://github.com/TencentBlueKing/bk-monitor/pull/11539) 已合入）
- 2026-07-16：更新 [APM Trace 写入 ES 字段类型冲突](./bkmonitor/troubleshooting/apm-trace-es-field-mapping-conflict.md) 的止血方案（按最新代码改为完整 drop 规则数组，并补充 Admin 配置与下发验证）
