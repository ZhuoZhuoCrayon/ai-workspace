...
| 时间           | 结论性进展                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|--------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `2026-06-18 16:00` | 完成第一轮代码落地与验证：<br />[a] 指标实现对齐水位、状态机状态、请求量 `3` 类协议，保留 `allowed` / `denied` 请求量口径 <br />[b] `throttle.enabled=false` 时过滤 HTTP / gRPC / admin 的 `throttle` 中间件，并跳过限流单例与采样回路初始化 <br />[c] 使用 Go `1.23.0` 执行 `go test ./internal/throttle ./receiver` 与 `go test ./internal/...` 通过。 |
