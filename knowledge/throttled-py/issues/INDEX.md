...
| 文件 | 标签 | 摘要 | 更新日期 |
|------|------|------|---------|
| [优化存储不可用时的异常处理](./2026-05-03-store-unavailable-error-handling/README.md) | `throttled-py` `store` `redis` `exception` `reliability` | 为存储后端异常提供统一的 StoreUnavailableError 包装，并以最小测试覆盖 sync / async 主路径 | 2026-05-05 |
